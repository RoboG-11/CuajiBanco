 ...
 */
public class comprobanteRetiroCon {
    public static boolean crearComprobanteRetiroConTarjeta(movRetiroConTarjeta CTar) throws FileNotFoundException, DocumentException, IOException {
        Document documento;
        FileOutputStream  archivo; 
        Rectangle pageSize = new Rectangle(200, 310);
        documento = new Document(pageSize,10,10,10,10);
        try{

            archivo = new FileOutputStream("./IMPRESORA/"+CTar.tipoTran+"_"+CTar.numTran+".pdf");
            ...
            Font f1 = new Font(Font.FontFamily.COURIER,8,Font.UNDERLINE,BaseColor.DARK_GRAY);
            Paragraph p1 = new Paragraph("RETIRO DE EFECTIVO CON TARJETA\n",f1);
             p1.setAlignment(Paragraph.ALIGN_CENTER);
            Font f2 = new Font(Font.FontFamily.COURIER,8,Font.BOLDITALIC,BaseColor.BLUE);
            Paragraph p2 = new Paragraph("Nombre - "+CTar.nombre+"\n",f2);
            p2.setAlignment(Paragraph.ALIGN_LEFT); 
            Font f3 = new Font(Font.FontFamily.COURIER,8,Font.BOLDITALIC,BaseColor.BLUE);
             Paragraph p3 = new Paragraph("Cliente - - - - - - - "+CTar.numCliente+"\n",f3);
             ...
             Paragraph p5 = new Paragraph("Cuenta - - - - - - - "+CTar.numCuenta+"\n",f5);
             p5.setAlignment(Paragraph.ALIGN_LEFT); 
             Paragraph p6 = new Paragraph("Tarjeta - - - - - "+CTar.numTarjeta+"\n",f5);
             p6.setAlignment(Paragraph.ALIGN_LEFT); 
            Font f7 = new Font(Font.FontFamily.HELVETICA,8,Font.BOLDITALIC,BaseColor.GRAY);
             Paragraph p7 = new Paragraph("Fecha y Hora - - "+CTar.FechayHora+"\n",f7);
             p7.setAlignment(Paragraph.ALIGN_LEFT); 
             Font f8 = new Font(Font.FontFamily.COURIER,8,Font.BOLDITALIC,BaseColor.ORANGE);
             Paragraph p8 = new Paragraph("TU RETIRO ES DE: C$"+CTar.monto+"\n",f8);
            ...
            Font f12 = new Font(Font.FontFamily.TIMES_ROMAN,7,Font.BOLDITALIC,BaseColor.BLACK);
             Paragraph p15 = new Paragraph("NÚMERO DE TRANSACCIÓN: "+CTar.numTran+"\n",f12);
           ...
           documento.add(p14);
            ...
            documento.add(p11);
             ...
             documento.add(p13);
            documento.close();
            System.out.println("Comprobante de Retiro de Efectivo Con Tarjeta, creado con exito");
